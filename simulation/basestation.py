...
from rb import RB
from rbg import RBG
from slice import Slice, SliceConfiguration
from intrasched import IntraSliceScheduler
from intersched import InterSliceScheduler
...
class BaseStation:
    ...
    def add_slice(self, slice_config: SliceConfiguration, intra_scheduler: IntraSliceScheduler) -> int:
    ...
    def generate_slice_users (
        ...
        self.slices[slice_id].generate_and_add_users(range(self.user_id, self.user_id+n_users))
